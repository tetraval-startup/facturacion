...
class Documentos_html {
	...
	public function get_html_boleta($data,$detalleComprobante) {
		$html = '
		...
		<body>    
			<table class="tablareceipt">
				<tbody>
					<tr>
						<td>
							<p>ServiTec Perú E.I.R.L.</p>
							<img class="logofactura" src="../assets/images/logos/logotipo-software.png">
							<p style="text-transform: none !important;">Defensores del morro kiwi - Chorrillos - Lima</p>
							...
							<p style="text-transform: none !important;"><img src="../assets/theme_doc_elect/images/email.svg" style="width: 12px;" /> Email: ventas@servitecperu.com</p>
						</td>
						<td class="datoruc">
							<p>R.U.C. 20604141240</p>                    
							<p>Boleta de Venta</p>
							<p>001 - '.$data['numero_comprobante'].'</p>
						</td>
					</tr>
				</tbody>
			</table>
					...
					<tr>
						<td class="tdatoslabel">
							<div style="padding-bottom: 10px; padding-right: 19px;">
								...
								<div style="margin-left: 105px; border-bottom: solid 1px #000;">'.$data['cliente_nombre'].'</div>
							</div>
						</td>
						<td class="tdatoslabel tdatodlabeldos">
							<div>
								<span style="float: left;">Fecha de Emisión:</span>
								<div style="margin-left: 118px; border-bottom: solid 1px #000;">'.$data['fecha_comprobante'].'</div>
							</div>
						</td>
					</tr>
					<tr>
						<td class="tdatoslabel">
							<div style="padding-bottom: 10px; padding-right: 19px;">
								...
								<div style="margin-left: 105px; border-bottom: solid 1px #000;">'.$data['cliente_numerodocumento'].'</div>
							</div>
						</td>
						<td class="tdatoslabel tdatodlabeldos">
							<div>
					...
					<tr>
						<td class="tdatoslabel">
							<div style="padding-bottom: 10px; padding-right: 19px;">
								...
								<div style="margin-left: 105px; border-bottom: solid 1px #000;">'.$data['cliente_direccion'].'</div>
							</div>
						</td>
					</tr>
				</tbody>
			...
			<div class="tablageneral">        
				<table cellpadding="0" cellspacing="0">
					<tbody>
						...
						$comprobante = mysqli_num_rows($detalleComprobante);
						while ($comprobante = mysqli_fetch_array($detalleComprobante)) {
						
						$html = $html.'
						<tr class="detalletable">
							<td class="nombredetalle">'.$comprobante['cantidad'].'</td>
							<td>'.$comprobante['nombreproducto'].'</td>
							<td>S/ '.$comprobante['valorunitario'].'</td>
							<td class="ulttable">'.$comprobante['valorventa'].'</td>
						</tr>';
					}
					$html = $html.'
					</tbody>
			...
			<div class="tablageneral tablacostos tablaboleta">        
				<table cellpadding="0" cellspacing="0">
					<tbody>   
						<tr class="detalletable">                                                                
							<td colspan="2">SON: Cinco Soles y 00/100 soles</td>
							<td class="preciotabla fintabla fintabla fintablados"><b>TOTAL</b></td>
							<td class="preciotabla ulttable fintabla">'.$data['txt_total_comprobante'].'</td>
						</tr>                 
					</tbody>
				</table>        
			</div>
				...
				<tbody>
					<tr>    
						...
						<td>
							...
							<br><span class="codigofac">HASH: '.$data['codigohash_comprobante'].'</span>
						</td>
					</tr>   
				</tbody>
			</table>
	...
	public function get_html_factura($data,$ruta_qr,$detalleComprobante) {
		$html = '
		<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		<html lang="es-ES" prefix="og: http://ogp.me/ns#" xmlns="https://www.w3.org/1999/xhtml">
		<head>   
		...
		<body>    
			<table class="tablareceipt">
				<tbody>
					<tr>
						<td>
							<p>ServiTec Perú Group E.I.R.L</p>
							<img class="logofactura" src="../assets/images/logos/logotipo-software.png">
							<p style="text-transform: none !important;">Defensores del morro kiwi - Chorrillos - Lima</p>
							<p style="text-transform: none !important;"><img src="../assets/theme_doc_elect/images/telephone.png" style="width: 12px;" /> Telf.: 677899900 / Cel.: 677788999</p>
							<p style="text-transform: none !important;"><img src="../assets/theme_doc_elect/images/email.svg" style="width: 12px;" /> Email: ventas@servitecperu.com</p>
				...
				<tbody>
					<tr>
						<td class="tdatoslabel">
							<div style="padding-bottom: 10px; padding-right: 19px;">
								...
								<div style="margin-left: 95px; border-bottom: solid 1px #000;">'.$data['cliente_nombre'].'</div>
							</div>
						</td>
						<td class="tdatoslabel tdatodlabeldos">
							<div>
					...
					<tr>
						<td class="tdatoslabel">
							<div style="padding-bottom: 10px; padding-right: 19px;">
								...
								<div style="margin-left: 95px; border-bottom: solid 1px #000;"> '.$data['cliente_numerodocumento'].'</div>
							</div>
						</td>
						<td class="tdatoslabel tdatodlabeldos">
							<div>
					...
					<tr>
						<td class="tdatoslabel">
							<div style="padding-bottom: 10px; padding-right: 19px;">
								<span style="float: left;">Dirección:</span>
								<div style="margin-left: 95px; border-bottom: solid 1px #000;">'.$data['cliente_direccion'].'</div>
							</div>
						</td>
					</tr>
				</tbody>
				...
				<table cellpadding="0" cellspacing="0">
					...
					$html = $html.		'
						<tr class="detalletable">
							...
							<td>Cinco Soles y 00/100 soles</td>
							<td></td>
						...
						<tr class="detalletable">                                                                
							...
							<td rowspan="3">
								<div style="clear: both; padding-bottom: 25px; width: 260px;">
									...
									<br>
									<span style="font-size: 11px">HASH: '.$data['codigohash_comprobante'].'</span>
								</div>
							</td>
							<td class="preciotabla fintabla fintablados"><b>Subtotal</b></td>
							<td class="preciotabla ulttable fintabla">'.$data['txt_subtotal_comprobante'].'</td>
						</tr> 
						<tr class="detalletable">                                                                
							
							
							<td class="preciotabla fintabla fintablados"><b>I.G.V. (18%)</b></td>
							<td class="preciotabla ulttable fintabla">'.$data['txt_igv_comprobante'].'</td>
						</tr>   
						<tr class="detalletable">
					...
					<tr>
						<td class="tdatoslabel" style="width: 50%; padding-right: 19px;">
							<div style="padding-bottom: 10px">
								<span style="float: left;">Nombre Cliente:</span>
								<div style="margin-left: 105px; border-bottom: dashed 1px #000 !important;">Roberto Mendoza Perca</div>
							</div>
						</td>
						<td class="tdatoslabel tdatodlabeldos">
							<div>
				...
				<tbody>            
					...
					<tr>
						<td class="tdatoslabel" style="width: 50%; padding-right: 19px;">
							<div style="padding-bottom: 10px">
								<span style="float: left;">Fecha de Emisión:</span>
								<div style="margin-left: 115px; border-bottom: dashed 1px #000 !important;">'.$data['fecha_comprobante'].'</div>
							</div>
						</td>
						<td class="tdatoslabel tdatodlabeldos">
							<div>
								<span style="float: left;">N°: </span>
								<div style="margin-left: 25px; border-bottom: dashed 1px #000 !important;">20604141240</div>
							</div>
						</td>
					</tr>
					<tr>
